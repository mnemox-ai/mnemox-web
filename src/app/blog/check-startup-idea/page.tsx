...
const methods = [
  ...
  },
  {
    ...
    time: '3–15 sec',
    coverage: 'GitHub + HN + npm + PyPI',
    pros: 'Scans 4 databases in parallel. Returns a 0–100 score with evidence, trend detection, and pivot suggestions. Runs inside your AI agent automatically.',
