...
const servers = [
  {
    ...
    description:
      'Persistent memory layer for AI trading agents. Three-layer architecture (raw trades → pattern discovery → strategy adjustment) with 20 MCP tools, Outcome-Weighted Memory, and an Evolution Engine that discovers strategies from raw price data.',
