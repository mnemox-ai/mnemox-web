export const en = {
  ...
  tm_tools_title: '20 MCP Tools',
  tm_tools_subtitle: 'Complete trading memory interface via Model Context Protocol.',
  tm_tools_group_memory: 'Memory & State',
  tm_tools_group_risk: 'Risk & Planning',
  tm_tools_group_evolution: 'Evolution Engine',
  tm_tools_group_audit: 'Audit & Review',
  tm_tool_remember_trade: 'Store a trade into OWM multi-layer memory; episodic, semantic, procedural and affective layers update automatically.',
  tm_tool_recall_memories: 'Recall memories using OWM outcome-weighted scoring, with a score breakdown per component.',
  tm_tool_get_behavioral_analysis: 'Behavioral analysis from procedural memory: overtrading, revenge trading, disposition effect.',
  tm_tool_get_agent_state: 'Current affective state: confidence, risk appetite, drawdown, recommended action.',
  tm_tool_compute_dqs: 'Compute a Decision Quality Score before executing a trade.',
  tm_tool_check_trade_legitimacy: 'Check whether the agent has enough data and confidence to be trading at all.',
  tm_tool_validate_strategy: 'Validate a strategy with statistical tests: Deflated Sharpe, walk-forward, regime split.',
  tm_tool_create_trading_plan: 'Create a prospective plan that activates when market conditions are met.',
  tm_tool_check_active_plans: 'Check active plans against the current market context and expire stale ones.',
  tm_tool_evo_fetch: 'Fetch OHLCV market data from Binance for evolution analysis.',
  tm_tool_evo_discover: 'Discover candidate trading patterns from market data using LLM analysis.',
  tm_tool_evo_backtest: 'Backtest a candidate pattern against historical OHLCV data.',
  tm_tool_evo_evolve: 'Run the full evolution loop: generate, backtest, select, eliminate.',
  tm_tool_evo_log: 'Read the log of past evolution runs from this session.',
  tm_tool_export_audit: 'Export Trading Decision Records for audit and compliance review.',
  tm_tool_verify_hash: 'Verify the integrity of a single Trading Decision Record by recomputing its hash.',
  tm_tool_verify_chain: 'Walk the whole audit chain end to end and report the first break, if any.',
  tm_tool_daily_root: 'Get or rebuild the daily Merkle root for a UTC date: one 32-byte anchor over that day.',
  tm_tool_strategy_perf: 'Aggregate performance stats per strategy.',
  tm_tool_trade_reflection: 'Full context and reflection for a specific trade.',
  ...
  pricing_faq1_q: 'What do I get when I upgrade?',
  pricing_faq1_a: 'The Free tier runs 3 strategy validations a month. Pro removes that cap and adds the detailed per-test breakdown. Nothing about your existing results changes when you upgrade.',
  pricing_faq2_q: 'Can I cancel anytime?',
  pricing_faq2_a: 'Yes. Cancel anytime from your dashboard and you keep Pro access until the end of the billing period you already paid for. Reports you have already generated stay downloadable.',
  pricing_faq3_q: 'What do I upload?',
  pricing_faq3_a: 'A CSV of the trades or returns from the strategy you want checked. Each validation runs four statistical tests (Deflated Sharpe, walk-forward, regime split, CPCV) and gives you a downloadable HTML report.',
  pricing_faq4_q: 'Is TradeMemory part of this?',
  pricing_faq4_a: 'No. TradeMemory is a separate open-source project, MIT licensed and self-hosted, with no paid tier and no hosted service. Nothing on this page applies to it.',
  ...
  check_gate_title: 'Get Your Full Strategy Report',
  check_gate_subtitle: "We'll email you a detailed PDF with competitor breakdown, market gaps, and actionable pivot strategies.",
  check_gate_bullet1: 'Deep competitor analysis with star counts and activity trends',
  check_gate_bullet2: 'Personalized pivot strategies based on market gaps',
  check_gate_bullet3: 'Weekly trend updates for your interest area',
  check_gate_email_placeholder: 'your@email.com',
  check_gate_submit: 'Send My Report',
  check_gate_footer: 'Free. No spam. Unsubscribe anytime.',
  check_gate_success: 'Report is on its way! Check your inbox in a few minutes.',
  check_gate_err_email: 'Please enter a valid email address.',
  ...
  svc_tier1_f1: 'SHA-256 tamper-evident decision records',
  ...
  p_tm_overview: "The industry's first MCP-native memory layer for AI trading agents. 5 memory types (episodic, semantic, procedural, affective, prospective), outcome-weighted recall, and SHA-256 tamper-evident decision records. Open source, MIT licensed, 1,514 tests.",
  p_tm_i1_val: '1,514',
