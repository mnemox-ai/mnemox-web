...
export const zh: Record<TranslationKey, string> = {
  ...
  pricing_faq1_q: '升級之後多了什麼？',
  pricing_faq1_a: '免費方案每月可跑 3 次策略驗證。Pro 拿掉這個上限，並加上每項檢定的詳細拆解。升級不會動到你既有的結果。',
  pricing_faq2_q: '可以隨時取消嗎？',
  pricing_faq2_a: '可以。隨時從 dashboard 取消，已付費的那個週期內仍保有 Pro 權限。已經產生的報告仍可下載。',
  pricing_faq3_q: '我要上傳什麼？',
  pricing_faq3_a: '一份包含你策略成交或報酬序列的 CSV。每次驗證會跑四項統計檢定（Deflated Sharpe、Walk-Forward、市況分段、CPCV），並產出可下載的 HTML 報告。',
  pricing_faq4_q: 'TradeMemory 也包含在裡面嗎？',
  pricing_faq4_a: '不包含。TradeMemory 是獨立的開源專案，MIT 授權、自架，沒有付費方案也沒有代管服務。本頁的內容都不適用於它。',
