...
export const zh: Record<TranslationKey, string> = {
  ...
  tm_tools_title: '20 個 MCP 工具',
  tm_tools_subtitle: '透過 Model Context Protocol 的完整交易記憶介面。',
  tm_tools_group_memory: '記憶與狀態',
  tm_tools_group_risk: '風險與計畫',
  tm_tools_group_evolution: '策略演化',
  tm_tools_group_audit: '稽核與回顧',
  tm_tool_remember_trade: '將一筆交易寫入 OWM 多層記憶，情節、語意、程序、情感四層自動更新。',
  tm_tool_recall_memories: '以 OWM 結果加權評分召回記憶，並附各分項的分數拆解。',
  tm_tool_get_behavioral_analysis: '從程序記憶做行為分析：過度交易、報復性交易、處置效應。',
  tm_tool_get_agent_state: '當前情感狀態：信心、風險偏好、回撤、建議動作。',
  tm_tool_compute_dqs: '下單前計算決策品質分數（DQS）。',
  tm_tool_check_trade_legitimacy: '檢查 agent 是否有足夠的資料與信心可以交易。',
  tm_tool_validate_strategy: '以統計檢定驗證策略：Deflated Sharpe、Walk-Forward、市況分段。',
  tm_tool_create_trading_plan: '建立前瞻計畫，在市場條件滿足時自動觸發。',
  tm_tool_check_active_plans: '以當前市場情境比對生效中的計畫，並讓過期的失效。',
  tm_tool_evo_fetch: '從 Binance 取得 OHLCV 市場資料供演化分析使用。',
  tm_tool_evo_discover: '用 LLM 分析從市場資料中找出候選交易型態。',
  tm_tool_evo_backtest: '用歷史 OHLCV 資料回測候選型態。',
  tm_tool_evo_evolve: '執行完整演化迴圈：生成、回測、篩選、淘汰。',
  tm_tool_evo_log: '讀取本 session 過去的演化執行紀錄。',
  tm_tool_export_audit: '匯出交易決策紀錄（TDR）供稽核與法遵審查。',
  tm_tool_verify_hash: '重算雜湊以驗證單筆交易決策紀錄的完整性。',
  tm_tool_verify_chain: '端到端走完整條稽核鏈，回報第一個斷點（若有）。',
  tm_tool_daily_root: '取得或重建某個 UTC 日期的每日 Merkle root，也就是當日所有紀錄的單一 32 bytes 錨點。',
  tm_tool_strategy_perf: '各策略的彙總績效統計。',
  tm_tool_trade_reflection: '單筆交易的完整脈絡與事後反思。',
  ...
  p_tm_m3_val: 'SHA-256',
  p_tm_m3_lbl: '審計追蹤',
  p_tm_overview: '業界首個為 AI 交易代理打造的 MCP 原生記憶層。5 種記憶類型（情節、語意、程序、情感、前瞻）、結果加權召回，以及 SHA-256 竄改可偵測的決策記錄。開源，MIT 授權，1,514 個測試。',
  p_tm_i1_val: '1,514',
  p_tm_i1_lbl: '測試通過',
  p_tm_i2_val: '17',
