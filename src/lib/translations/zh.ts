...
export const zh: Record<TranslationKey, string> = {
  ...
  svc_usecase_1_role: 'Jack R.',
  svc_usecase_1_meta: '算法交易 \u00b7 倫敦',
  svc_usecase_2: '光是審計追蹤就值了。我的 EA 做的每個決策現在都有完整上下文紀錄 — 監管機構看了都滿意。',
  svc_usecase_2_role: 'Marcus W.',
  svc_usecase_2_meta: '合規 \u00b7 法蘭克福',
  svc_usecase_3: '我們同時跑 4 個策略，用同一套風控引擎。斷路器至少幫我們擋掉了 3 次閃崩。',
  svc_usecase_3_role: 'Daniel K.',
  svc_usecase_3_meta: '自營商 \u00b7 新加坡',
  svc_usecase_4: 'Bloomberg 風格的儀表板讓我用手機就能監控所有策略。不用再凌晨 3 點 SSH 進伺服器了。',
  svc_usecase_4_role: 'Kelly C.',
  svc_usecase_4_meta: '量化開發 \u00b7 台北',
  svc_usecase_5: '從 Excel 轉到 TradeMemory 做交易日誌。模式發現功能找出我表現最差的時段是亞洲開盤 — 之前完全沒注意到。',
  svc_usecase_5_role: 'Raj P.',
  svc_usecase_5_meta: '波段交易 \u00b7 孟買',
  svc_usecase_6: 'MCP 整合讓 Claude 能存取我的完整交易歷史。策略分析完全升級。',
  svc_usecase_6_role: 'Tomasz L.',
  svc_usecase_6_meta: 'AI 開發 \u00b7 華沙',
